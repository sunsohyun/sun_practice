...
<script src="http://localhost:9000/practice_sun/js/jquery-3.6.4.min.js"></script>
<script src="http://localhost:9000/practice_sun/js/reservation_jquery.js"></script>
</head>
<body>
<div>
	...
	<div class="page">
		<div class="login_wrap">
			...
			<div class="box_login">
				...
				<p class="h3_desc"><span class="text_blue">고속버스 통합 홈페이지</span>는 고속버스모바일앱의 회원 아이디와 비밀번호로 이용이 가능합니다.</p>
				<div class="inner">
					<fieldset>
						<!-- <legend>회원로그인</legend> -->
						<ul class="loginList">
